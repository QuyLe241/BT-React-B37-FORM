...
const FormMain = () => {
  ...
  const {
    handleChange, values, handleSubmit, setFieldValue, resetForm,
  ...
  return (
    <div className='container mx-auto px-8'>
      ...
      <TableSinhVien arrSinhVien={filteredSinhVien} handleDeleteSinhVien={handleDeleteSinhVien} handleGetSinhVien={handleGetSinhVien} />
    </div>
  )
}
